...
export const catagoriesData=[
    {id:1,
    catagoriesName:'Best Seller',
    books:[
        bookOtherWordsForHome, bookTheMetropolis,bookTheTinyDragon
    ]
},
{id:2,
    catagoriesName:'The Latest' ,
    books:[
        bookTheMetropolis
    ]
},
{id:3,
    catagoriesName:'Coming Soon' ,
    books:[
        bookTheTinyDragon
    ]
}
]
export default {bookOtherWordsForHome,bookTheMetropolis,bookTheTinyDragon,profileData,myBooksData,catagoriesData}